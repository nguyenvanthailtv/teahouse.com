...
const search = () => {
  ...
  if (inputSearch.value) {
    ...
    router.push({ path: '/search', query: { searchText: inputSearch.value } })
    inputSearch.value = ''
  }
}
</script>
  ...
  <header class="border-b-[1px] border-b-[rgba(0,0,0,0.1)]">
      ...
      <div class="bg-primary">
        <div class="container mx-auto flex items-center justify-between py-1 text-white">
          ...
          <ul class="flex items-center">
            <li class=" bg-white pl-5 pr-3 mx-2 rounded-[20px] h-auto text-secondary">
              <form @submit.prevent="search">
                <input v-model="inputSearch" type="text" class="flex-1 py-2 px-1 outline-0" placeholder="Tìm kiếm...">
                <svg
                  id="Glyph"
                  fill="currentColor"
            ...
            <!--              <span class="hover-transition account__title">-->
            <!--                <svg-->
            <!--                  xmlns="http://www.w3.org/2000/svg"-->
            <!--                  fill="none"-->
            <!--                  viewBox="0 0 24 24"-->
            ...
            <!--              <div class="dropdown-menu absolute left-0 hover-transition right-0 box-shadow translate-y-[100%] opacity-0 bg-white text-secondary px-3 py-2 rounded-[6px]">-->
            <!--                <div>-->
            <!--                  <nuxt-link to="#" class="hover:text-primary py-1 block  hover-transition">-->
            <!--                    Đăng nhập-->
            <!--                  </nuxt-link>-->
            <!--                  <nuxt-link to="#" class="hover:text-primary py-1 block  hover-transition">-->
            <!--                    Đăng ký-->
    ...
    <section class="header-2 block lg:hidden bg-primary py-2">
      ...
      <div class="container mx-auto">
        <div class=" flex items-center justify-between bg-white px-3">
          <input type="text" name="" class="flex-1 py-2 px-1 outline-0" placeholder="Tìm kiếm...">
          <svg
            id="Glyph"
            fill="currentColor"
            class="w-6 h-6  inline"
